          ...
          <section className="relative overflow-hidden bg-[#111111]">
            <div className="relative h-[46vh] min-h-[360px] max-h-[520px] overflow-hidden">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, #111111 0%, rgba(17,17,17,0.55) 55%, rgba(17,17,17,0.15) 100%)",
                }}
              />
            </div>
              ...
              <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
                <div className="max-w-3xl">
                  <div className="flex items-center gap-3 mb-5">
                    <span className="inline-block w-8 h-[2px]" style={{ background: "var(--nb-gold)" }} />
                    <p
                      className="text-[10px] tracking-[0.34em] uppercase font-semibold"
                      style={{ color: "var(--nb-gold)", fontFamily: "'Lato', sans-serif" }}
                    >
                  ...
                  <h1
                    ...
                    style={{
                      ...
                      fontSize: "clamp(3.0rem, 7vw, 5.2rem)",
                    }}
                  >
                    A corner bakery
                    <br />
                    <span style={{ color: "var(--nb-gold)" }}>for real life</span>
                  </h1>
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14 md:py-18 grid gap-10 md:grid-cols-12 items-start">
              ...
              <div className="md:col-span-7">
                <div className="rounded-2xl border border-black/10 bg-white shadow-sm p-8 md:p-10">
                  ...
                  <div className="h-[2px] w-12 mb-6" style={{ background: "rgba(176,141,87,0.55)" }} />
          ...
          <section style={{ background: "#fffaf0" }}>
            <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14 md:py-18">
              <div className="text-center mb-10">
                <p
                  className="text-[10px] tracking-[0.34em] uppercase font-semibold mb-3"
                  style={{ color: "var(--nb-gold)", fontFamily: "'Lato', sans-serif" }}
                >
                  What matters here
                </p>
                ...
                {[
                  ...
                  <div key={x.title} className="rounded-2xl border border-black/10 bg-white shadow-sm p-7">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="inline-block w-2 h-2 rounded-full" style={{ background: "var(--nb-gold)" }} />
